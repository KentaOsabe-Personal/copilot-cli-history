...
### Requirement 2: insert / update / skip 判定
...
### Requirement 4: root failure と error response
...
### Requirement 5: degraded session の継続保存
